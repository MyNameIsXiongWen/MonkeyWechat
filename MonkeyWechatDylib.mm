...
@class WCTableViewNormalCellManager; @class WCBizUtil; @class WCRedEnvelopesLogicMgr; @class CMessageMgr; @class WCTableViewCellManager; @class WCTableViewSectionManager; @class MMMassSendContactSelectorViewController; @class CContactMgr; @class MMMassSendWriteMessageViewController; @class WCDeviceStepObject; @class MassSendContentLogicController; @class NewSettingViewController; @class MMServiceCenter; 
...
static void _logos_method$_ungrouped$MassSendContentLogicController$OnAddMsg$MsgWrap$(_LOGOS_SELF_TYPE_NORMAL MassSendContentLogicController* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, id arg1, id arg2) {
    _logos_orig$_ungrouped$MassSendContentLogicController$OnAddMsg$MsgWrap$(self, _cmd, arg1, arg2);
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(1 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
